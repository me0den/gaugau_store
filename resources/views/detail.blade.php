         ...
         <div class="container">
            <div class="col-md-8 showcase">
               <div class="flexslider">
                  <ul class="slides">
                     <li data-thumb="{{ asset('images/show.jpg') }}">
                        <div class="thumb-image"> <img src="{{ asset('images/show.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                     </li>
                     <li data-thumb="{{ asset('images/show1.jpg') }}">
                        <div class="thumb-image"> <img src="{{ asset('images/show1.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                     </li>
                     <li data-thumb="{{ asset('images/show2.jpg') }}">
                        <div class="thumb-image"> <img src="{{ asset('images/show2.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                     </li>
                     <li data-thumb="{{ asset('images/show3.jpg') }}">
                        <div class="thumb-image"> <img src="{{ asset('images/show3.jpg') }}" data-imagezoom="true" class="img-responsive"> </div>
                     </li>
                  </ul>
      ...
      <div class="you-might-like">
         <div class="container">
            ...
            <div class="col-md-4 grid-stn simpleCart_shelfItem">
               ...
               <div class="ih-item square effect3 bottom_to_top">
                  <div class="bottom-2-top">
                     <div class="img"><img src="{{ asset('images/grid4.jpg') }}" alt="/" class="img-responsive gri-wid"></div>
                     <div class="info">
            ...
            <div class="col-md-4 grid-stn simpleCart_shelfItem">
               ...
               <div class="ih-item square effect3 bottom_to_top">
                  <div class="bottom-2-top">
                     <div class="img"><img src="{{ asset('images/grid6.jpg') }}" alt="/" class="img-responsive gri-wid"></div>
                     <div class="info">
                        <div class="pull-left styl-hdn">
                           <h3>style 01</h3>
                        </div>
